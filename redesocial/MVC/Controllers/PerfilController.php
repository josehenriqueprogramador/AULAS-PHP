			...
			if(isset($_SESSION['login'])){
				...
				if(isset($_POST['atualizar'])){
					...
					if($nome == '' || strlen($nome) < 3){
						\MVC\Utilidades::alerta('Você precisa inserir um nome...');
						\MVC\Utilidades::redirect(INCLUDE_PATH.'perfil');
					}
					...
					if($_FILES['file']['tmp_name'] != ''){
						...
						if($fileExt == 'png' || $fileExt == 'jpg' ||$fileExt == 'jpeg'){
							...
							if($size <= 300){
								...
								\MVC\Utilidades::alerta('Seu perfil foi atualizado junto com a foto!');
								\MVC\Utilidades::redirect(INCLUDE_PATH.'perfil');

								
							}else{
								\MVC\Utilidades::alerta('Erro ao processar seu arquivo.');
								\MVC\Utilidades::redirect(INCLUDE_PATH.'perfil');
							}
						}else{
							\MVC\Utilidades::alerta('Erro ao processar seu arquivo.');
					...
					\MVC\Utilidades::alerta('Seu perfil foi atualizado com sucesso!');
					\MVC\Utilidades::redirect(INCLUDE_PATH.'perfil');
				...
				\MVC\Views\MainView::render('perfil');
			}else{
