	...
	class HomeModel{
		...
		public static function retrieveFriendsPosts(){
			...
			foreach ($amigosConfirmados as $key => $value) {
				$listaAmigos[$key]['id'] = \MVC\Models\UsuariosModel::getUsuarioById($value)['id'];
				$listaAmigos[$key]['nome'] = \MVC\Models\UsuariosModel::getUsuarioById($value)['nome'];
				$listaAmigos[$key]['email'] = \MVC\Models\UsuariosModel::getUsuarioById($value)['email'];
				$listaAmigos[$key]['img'] = \MVC\Models\UsuariosModel::getUsuarioById($value)['img'];
				$listaAmigos[$key]['ultimo_post'] = \MVC\Models\UsuariosModel::getUsuarioById($value)['ultimo_post'];
			}
