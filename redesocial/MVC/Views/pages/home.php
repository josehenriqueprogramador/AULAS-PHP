...
<body>
	...
	<section class="main-feed">
		...
		<?php
			$retrievePosts = \MVC\Models\HomeModel::retrieveFriendsPosts();
		...
		<?php } ?>
			...
			<div class="friends-request-feed">
				...
				<?php
					...
					foreach(\MVC\Models\UsuariosModel::listarAmizadesPendentes() as $key=>$value){
					$usuarioInfo = \MVC\Models\UsuariosModel::getUsuarioById($value['enviou']);
				?>
