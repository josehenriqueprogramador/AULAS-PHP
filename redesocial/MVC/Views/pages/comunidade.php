		...
		<div class="feed">
			...
			<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						<?php foreach(\MVC\Models\UsuariosModel::listarAmigos() as $key => $value){ ?>
			...
			<br/>
				...
				<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						...
						<?php
							$comunidade = \MVC\Models\UsuariosModel::listarComunidade();
						...
						<div class="container-comunidade-single">
							...
							<div class="btn-solicitar-amizade">
								<?php
									if(\MVC\Models\UsuariosModel::existePedidoAmizade($value['id'])){
								?>
